...
class MainMenu(Scene):
    def __init__(self, parent):
        ...
        self.name_label = Label(parent, text="Main menu")
        ...
        self.pass_label = Label(parent, text="Photo:")
        self.pass_entry = Entry(parent)
        self.add_photo = Button(parent, text="Change data")
        self.add_button = Button(parent, text="Detect people")
    ...
    def show(self):
        ...
        self.add_photo.grid(row=4, column=0, sticky=W + E, padx=10)
